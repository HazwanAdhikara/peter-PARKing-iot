  ...
  return (
    <div className="h-screen flex items-center justify-center bg-opacity-10">
      <div className="mx-6 font-sans p-12 bg-black bg-opacity-70 rounded-xl shadow-2xl text-center">
        <div className="text-6xl font-extrabold text-blue-500 mb-6 drop-shadow-lg tracking-wide leading-snug">
          Peter <span className="text-red-500">PARK</span>ing
        </div>
        <div className="text-red-400">
          <p className="font-semibold mt-3 text-2xl mb-8 drop-shadow-md tracking-wide">
